 ...
 * @author b_kotsana
 */
public class SignIntransport extends javax.swing.JFrame {

    /** Creates new form SignIntransport */
    public SignIntransport() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignIntransport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignIntransport().setVisible(true);
            }
        });
    }

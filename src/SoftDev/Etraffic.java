 ...
 * @author b_kotsana
 */
public class Etraffic extends javax.swing.JFrame {

    /**
     * Creates new form Etraffic
     */
    public Etraffic() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Etraffic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

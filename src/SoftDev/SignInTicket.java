 ...
 * @author b_kotsana
 */
public class SignInTicket extends javax.swing.JFrame {

    /**
     * Creates new form SignInTicket
     */
    public SignInTicket() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignInTicket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignInTicket().setVisible(true);
            }
        });
    }

 ...
 * @author b_kotsana
 */
public class Proccessing1 extends javax.swing.JFrame {

    /**
     * Creates new form Proccessing1
     */
    public Proccessing1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Proccessing1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Proccessing1().setVisible(true);
            }
        });
    }

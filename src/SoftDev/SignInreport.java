 ...
 * @author b_kotsana
 */
public class SignInreport extends javax.swing.JFrame {

    /**
     * Creates new form SignInreport
     */
    public SignInreport() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignInreport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignInreport().setVisible(true);
            }
        });
    }
